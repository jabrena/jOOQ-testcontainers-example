...
import static org.jooq.example.testcontainers.db.tables.Actor.ACTOR;
import static org.jooq.example.testcontainers.db.tables.Category.CATEGORY;
...
public class TestContainersTest {
    ...
    void find_all_actors_of_horror_films() {
        Result<Record2<String, String>> actorsOfHorrorFilms = ctx
                ...
                .from(ACTOR)
                .join(FilmActor.FILM_ACTOR).on(FilmActor.FILM_ACTOR.ACTOR_ID.eq(ACTOR.ACTOR_ID))
                .join(org.jooq.example.testcontainers.db.tables.Film.FILM).on(FilmActor.FILM_ACTOR.FILM_ID.eq(org.jooq.example.testcontainers.db.tables.Film.FILM.FILM_ID))
                .join(FilmCategory.FILM_CATEGORY).on(FilmCategory.FILM_CATEGORY.FILM_ID.eq(org.jooq.example.testcontainers.db.tables.Film.FILM.FILM_ID))
                .join(CATEGORY).on(FilmCategory.FILM_CATEGORY.CATEGORY_ID.eq(CATEGORY.CATEGORY_ID))
    ...
    void find_all_actors_of_horror_films_implicit_join() {
        Result<Record2<String, String>> actorsOfHorrorFilms = ctx
                ...
                .join(FilmCategory.FILM_CATEGORY).on(FilmActor.FILM_ACTOR.FILM_ID.eq(FilmCategory.FILM_CATEGORY.FILM_ID))
